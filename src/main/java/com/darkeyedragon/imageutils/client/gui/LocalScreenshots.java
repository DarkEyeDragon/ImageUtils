...
import com.darkeyedragon.imageutils.client.ImageResource;
...
public class LocalScreenshots extends GuiScreen{
    ...
    private LocalScreenshots.List list;
    ...
    public LocalScreenshots(GuiScreen parentScreen){
    ...
    public void initGui(){
        ...
        deleteButton = new GuiButton(4, this.width / 2 - 50, this.height - 52, 100, 20, "Delete");
        uploadButton = new GuiButton(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, "Upload");
        refreshButton = new GuiButton(8, this.width / 2 + 4, this.height - 28, 70, 20, "Refresh");
        cancelButton = new GuiButton(0, this.width / 2 + 4 + 76, this.height - 28, 75, 20, I18n.format("gui.cancel"));
        ...
        this.list = new LocalScreenshots.List(this.mc);
    ...
    protected void actionPerformed(GuiButton button)
    {
        if(button == cancelButton){
            ...
            mc.displayGuiScreen(new GuiUploaders());
        }
    ...
    class List extends GuiSlot
    {
        ...
        List(Minecraft mcIn)
        {
            super(mcIn, LocalScreenshots.this.width, LocalScreenshots.this.height, 32, LocalScreenshots.this.height - 65 + 4, 18);
        ...
        {
            return LocalScreenshots.this.screenshots.size();
        }
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY)
        {
            //if(!clickedBefore){
                ...
                LocalScreenshots.this.isSelected = true;
        ...
        {
            LocalScreenshots.this.drawDefaultBackground();
        }

        protected void drawSlot(int slotIndex, int xPos, int yPos, int heightIn, int mouseXIn, int mouseYIn, float partialTicks)
        {
            LocalScreenshots.this.drawCenteredString(LocalScreenshots.this.fontRenderer, (screenshots.get(slotIndex).getName()), this.width / 5, yPos + 1, 16777215);
        }
